...
/**
 * @brief Suspends execution of the calling thread for at least the specified number of seconds.
 * @param [in] time_in_seconds Time to sleep in seconds
 *
...
/**
 * @brief Suspends execution of the calling thread for at least the specified number of milliseconds.
 * @param [in] time_in_milliseconds Time to sleep in milliseconds
 *
 * The actual sleep duration may be longer than requested due to system scheduling.
 */
