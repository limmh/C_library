...
#define INTMAX_C(integer) (integer##LL)
#else
...
#elif defined(INT64_MIN) && (INT_LEAST8_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_LEAST8_MAX == INT64_MAX)
...
#elif defined(INT64_MIN) && (INT_FAST8_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_FAST8_MAX == INT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_LEAST8_MAX == UINT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_FAST8_MAX == UINT64_MAX)
...
#elif defined(INT64_MIN) && (INT_LEAST16_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_LEAST16_MAX == INT64_MAX)
...
#elif defined(INT64_MIN) && (INT_FAST16_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_FAST16_MAX == INT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_LEAST16_MAX == UINT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_FAST16_MAX == UINT64_MAX)
...
#elif defined(INT64_MIN) && (INT_LEAST32_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_LEAST32_MAX == INT64_MAX)
...
#elif defined(INT64_MIN) && (INT_FAST32_MIN == INT64_MIN) && defined(INT64_MAX) && (INT_FAST32_MAX == INT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_LEAST32_MAX == UINT64_MAX)
...
#elif defined(UINT64_MAX) && (UINT_FAST32_MAX == UINT64_MAX)
...
#elif defined(INT64_MIN) && (INTMAX_MIN == INT64_MIN) && defined(INT64_MAX) && (INTMAX_MAX == INT64_MAX)
...
#elif defined(UINT64_MAX) && (UINTMAX_MAX == UINT64_MAX)
...
#elif defined(INT64_MIN) && (INTPTR_MIN == INT64_MIN) && defined(INT64_MAX) && (INTPTR_MAX == INT64_MAX)
...
#if defined(INT64_MIN) && (SIG_ATOMIC_MIN == INT64_MIN) && defined(INT64_MAX) && (SIG_ATOMIC_MAX == INT64_MAX)
#define SIG_ATOMIC_WIDTH 64U
#elif (SIG_ATOMIC_MIN == INT32_MIN) && (SIG_ATOMIC_MAX == INT32_MAX)
#define SIG_ATOMIC_WIDTH 32U
#elif (SIG_ATOMIC_MIN == INT16_MIN) && (SIG_ATOMIC_MAX == INT16_MAX)
#define SIG_ATOMIC_WIDTH 16U
#elif (SIG_ATOMIC_MIN == INT8_MIN) && (SIG_ATOMIC_MAX == INT8_MAX)
#define SIG_ATOMIC_WIDTH 8U
#else
#pragma message("Detection of width failed for sig_atomic_t. SIG_ATOMIC_WIDTH will not be defined.")
#endif
#endif /* SIG_ATOMIC_WIDTH */

#ifndef WCHAR_WIDTH
#if defined(_WIN64) || defined(_WIN32) || defined(WIN64) || defined(WIN32)
#define WCHAR_WIDTH 16U
#else
#define WCHAR_WIDTH 32U
#endif
#endif /* WCHAR_WIDTH */

#ifndef WINT_WIDTH
#define WINT_WIDTH 32U
#endif /* WINT_WIDTH */

#if !(defined(INT64_MIN) && defined(INT64_MAX))
#pragma message("int64_t is probably not supported.")
#endif

#if !defined(UINT64_MAX)
#pragma message("uint64_t is probably not supported.")
#endif

#endif /* FIXED_WIDTH_INTEGER_TYPES_H */
