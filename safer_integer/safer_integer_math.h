...
INLINE_OR_STATIC
Boolean_type i32_is_even(int32_t integer) {
	return (integer % 2) == 0;
}

INLINE_OR_STATIC
Boolean_type i32_is_odd(int32_t integer) {
	return !i32_is_even(integer);
}

INLINE_OR_STATIC
Boolean_type u32_is_even(uint32_t integer) {
	return (integer % 2U) == 0U;
}

INLINE_OR_STATIC Boolean_type u32_is_odd(uint32_t integer) {
...
INLINE_OR_STATIC Boolean_type i64_is_even(int64_t integer) {
	return (integer % 2) == 0;
}

INLINE_OR_STATIC Boolean_type i64_is_odd(int64_t integer) {
	return !i64_is_even(integer);
}

INLINE_OR_STATIC Boolean_type u64_is_even(uint64_t integer) {
	return (integer % 2U) == 0U;
}

INLINE_OR_STATIC Boolean_type u64_is_odd(uint64_t integer) {
